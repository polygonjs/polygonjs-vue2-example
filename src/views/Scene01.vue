...
export default Vue.extend({
  ...
  methods: {
      ...
      onSceneReady: function(scene: PolySceneWithNodeMap_scene_01){
          this.$data.scene = scene;
          this.updateCount();
      },
      updateCount: function(){
          const scene = this.$data.scene as PolySceneWithNodeMap_scene_01|null
          if(!scene){return}
          scene.node('/geo1/copy1').p.count.set(this.$data.count)
      }
  }
});
</script>
